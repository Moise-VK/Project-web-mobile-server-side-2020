...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticketsdb`.`events` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticketsdb`.`sellers` ;
...
CREATE TABLE IF NOT EXISTS `ticketsdb`.`tickets` (
  ...
  INDEX `fk_tickets_evenementen_idx` (`event_id` ASC),
  INDEX `fk_tickets_verkopers1_idx` (`seller_id` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticketsdb`.`artists` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticketsdb`.`events_has_artists` ;
